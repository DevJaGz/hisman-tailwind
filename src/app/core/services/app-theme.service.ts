...
export class AppThemeService {
	...
	get isDarkTheme$(): Observable<boolean> {
		return this.currentTheme$.pipe(map(currentTheme => currentTheme === THEME.DARK));
	}

	constructor(private localStorageService: LocalStorageService, private windowService: WindowService) {}
